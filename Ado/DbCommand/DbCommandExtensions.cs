...
namespace System.Data.Common {
  ...
  public static class DbCommandExtensions {
    ...
    public static DbParameter AddParameter(this DbCommand command, string name, DbType dbType, object value, ParameterDirection direction = ParameterDirection.Input) {
